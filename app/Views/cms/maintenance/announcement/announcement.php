    ...
    function save_data(action, id) {
        ...
        if(validate.standard("popup_modal")){
            if (id !== undefined && id !== null && id !== '') {
                check_current_db("tbl_announcements", ["title", "description_1", "description_3", "start_date", "end_date"], [title, desc_1, desc_3, start_date, end_date], "status" , "id", id, true, function(exists, duplicateFields) {
                    if (!exists) {
                ...
                check_current_db("tbl_announcements", ["title", "description_1", "description_3", "start_date", "end_date"], [title, desc_1, desc_3, start_date, end_date], "status" , null, null, true, function(exists, duplicateFields) {
                    if (!exists) {
