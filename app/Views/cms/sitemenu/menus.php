            ...
            <div class="modal-body">
                <form id="form-modal">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control required" id="menu_name" aria-describedby="menu_name" maxlength="50">
...
<script>    
    ...
    function get_data(query) {
        ...
        var data = {
            event : "list",
            select : "id, menu_url, menu_name, default_menu, menu_type, created_date, updated_date, status, menu_parent_id",
            query : query,
            offset : offset,
            limit : limit,
            table : "site_menu",
        ...
        aJax.post(url,data,(result) => {
            ...
            if(result) {
                if (result.length > 0) {
                    ...
                    get_field_values('site_menu', 'menu_name', 'id', menu_id_list, (res)=>{
                        console.log(res)
    ...
    function save_data(action, id) {
        ...
        check_current_db("site_menu", db_fields, input_fields, "status" , excludeField, excludeId, true, function(exists, duplicateFields) {
            if(!exists) {
                if (id !== undefined && id !== null && id !== '') {
                    console.log('edit')
