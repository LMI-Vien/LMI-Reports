...
.card-body {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-save-modal" style="background-color: white !important; width: 100%;">
                        <div class="mb-3">
                            <label for="code" class="form-label">Code</label>
                            <input type="text" class="form-control required" id="code" aria-describedby="store_code">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control required" id="description" aria-describedby="store_description">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="store" class="form-text text-muted">* required, must be unique, max 50 characters</small>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form style="background-color: white !important; width: 100%;">
                        ...
                        <div class="mb-3">
                            <label for="description" class="form-label">Store</label>
                            <input type="text" class="form-control" id="v_store" aria-describedby="store" readonly disabled >
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form style="background-color: white !important; width: 100%;">
                        ...
                        <div class="mb-3">
                            <label for="code" class="form-label">Code</label>
                            <input type="text" class="form-control required" id="e_code" aria-describedby="store_code">
                            <small class="form-text text-muted">* required, must be unique, max 25 characters</small>
                        </div>
                        
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <input type="text" class="form-control required" id="e_description" aria-describedby="store_description">
                            <small class="form-text text-muted">* required, must be unique, max 50 characters</small>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label">Store</label>
                            <input type="text" class="form-control required" id="e_store" aria-describedby="store">
                            <small class="form-text text-muted">* required, must be unique, max 50 characters</small>
                        </div>
    ...
    <script>
        ...
        function save_data(e) {
            ...
            if(client_validate_data(code, description, store)) {
                check_current_db(function (result) {
                    var err_msg = '';
                    var valid = true;
                    ...
                    if(!valid){
                        ...
                        modal.confirm("Are you sure you want to save this record?",function(result){
                            if(result){ 
                                save_to_db(code, description, store, status_val)
                            }
                        })
                    };
                })
        ...
        function save_to_db(inp_code, inp_description, inp_store, status_val) {
        ...
        function update_data(id) {
            ...
            var inp_store = $('#e_description').val()
            var chk_status = $('#e_status').prop('checked')

            if(client_validate_data(inp_code, inp_description, inp_store, store)) {
                var err_msg = '';
                var valid = true;
                ...
                if(result) {
                    if (result.length > 0) {
                        $.each(result, function(x,y) {
                            ...
                            html += "<td style='width: 40%'>" + y.store + "</td>";
