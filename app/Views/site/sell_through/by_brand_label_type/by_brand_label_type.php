...
<?= view("site/sell_through/by_brand_label_type/by_brand_label_type_filter"); ?> 
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card mt-4 p-4 shadow-sm hide-div">
                            ...
                            <div id="tableContainer" class="mb-3" style="overflow-x: auto; height: 600px; padding: 0px;">
                                <table id="sellThroughByBrandType" class="table table-bordered" style="width: 100% !important;">
                                    <thead>
                                        <tr>
                                            <th 
                                                colspan="5"
                                                ...
                                                class="static-header"
                                            >
                                                SELL THROUGH BY Brand Label Type
                                            </th>
                                        </tr>
                                        <tr>
