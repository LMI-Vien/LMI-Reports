        ...
        aJax.post(url2, data, function (result) {
            ...
            if (result.data.length > 0) {
                ...
                $.each(result.data, function(x,y) {
                    ...
                    html += '<tr><td style="background-color: #ebe6f3;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Balance To Target</td><td>'+formatTwoDecimals(y.balance_to_target_jan || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_feb || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_mar || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_apr || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_may || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_jun || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_jul || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_aug || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_sep || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_oct || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_nov || "0.00")+'</td><td>'+formatTwoDecimals(y.balance_to_target_dec || "0.00")+'</td><td>'+formatTwoDecimals(y.total_balance_to_target || "0.00")+'</td></tr>';
                    if(session_role == 7 || session_role == 8 ){
                        html += '<tr><td style="background-color: #ebe6f3;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">% Growth</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></td><td>-</td></tr>';
                    }else{
                    ...
                    html += '<tr><td style="background-color: #ebe6f3;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Balance To Target</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td></td><td>-</td></tr>';
                    ...
                    html += '<tr><td style="background-color: #339933;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">% Achieved</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td></td><td>-</td></tr>';
            }
