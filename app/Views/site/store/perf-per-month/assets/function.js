        ...
        aJax.post(url2, data, function (result) {
            ...
            if (result.data.length > 0) {
                ...
                $.each(result.data, function(x,y) {
                    ...
                    html += '<tr><td style="background-color: #990000;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Target Sales</td><td>'+formatTwoDecimals(y.target_sales_jan || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_feb || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_mar || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_apr || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_may || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_jun || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_jul || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_aug || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_sep || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_oct || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_nov || "0.00")+'</td><td>'+formatTwoDecimals(y.target_sales_dec || "0.00")+'</td></tr>';
                    ...
                    html += '<tr><td style="background-color: #ebe6f3;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" class="labeltext">% Growth<span class="tooltip-text">FORMULA:<br>(TY Sell Out - LY Sell Out / LY Sell Out) * 100%</span></td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td><td>0.00</td></tr>';
