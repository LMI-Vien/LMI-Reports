...
class TradeDashboard extends BaseController
{
	...
	public function overall_asc()
	{
		...
		$data['PageName'] = 'Trade Dashboard';
		$data['PageUrl'] = 'Trade Dashboard';
		$data["breadcrumb"] = array('Store' => base_url('trade-dashboard/overall-asc'),'Store Sales Performance per Area' => '');
		$data["source"] = "Scan Data / Actual Sales Report";
		$data["source_date"] = 'Monthy to';	
	...
	public function asc_dashboard()
	{
		...
		$data['PageName'] = 'Trade Dashboard';
		$data['PageUrl'] = 'Trade Dashboard';
		$data["breadcrumb"] = array('Store' => base_url('trade-dashboard/asc-dashboard-1'),'Store Sales Performance per Month' => '');
		$data["source"] = "Scan Data / Actual Sales Report";
		$data["source_date"] = 'Monthy to';	
		$data["foot_note"] = 'With BA - Achieved = Scan data, Sales report, Target sales';	
	...
	public function info_kam2()
	{
		...
		$data["breadcrumb"] = array('Stocks' => base_url('trade-dashboard/info-kam-2'),'Week by Week Stock Data of all Stores' => '');
		$data["source"] = "VMI dummy";
