...
class PricelistDetails extends BaseController
{
    protected $session;
	...
	public function index()
	{
		...
		$data['title'] = "PricelistDetails";
		$data['PageName'] = 'PricelistDetails';
		$data['PageUrl'] = 'PricelistDetails';
		$data['buttons'] = ['add', 'search', 'filter'];
		$data['content'] = "cms/pricelist_details/pricelist_details.php";
